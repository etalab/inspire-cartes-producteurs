...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__regions_2017_json__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__regions_2017_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__regions_2017_json__);



console.log(__WEBPACK_IMPORTED_MODULE_1__regions_2017_json___default.a);
...
function filterOrganization(organization) {
  ...
  for (var i = 0; i < labels.length; i++) {
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash__["includes"])(organization.value, labels[i])) return true
  }
  return false
}
...
function matchDRAAFAndOldRegion(newRegionsMatch, organization) {
  for (var i = 0; i < newRegionsMatch.length; i++) {
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash__["includes"])(newRegionsMatch[i].draaf, organization.value)) {
  ...
  .addEventListener('load', function() {
    Promise.all([facetsPromise, regionsPromises])
      .then(response => {
        ...
        const organizations = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash__["filter"])(facets.organization, (organization) => filterOrganization(organization))
